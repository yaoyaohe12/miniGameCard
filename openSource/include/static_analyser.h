...
class StaticAnalyserC {
    public:
        ...
        //
        bool Is510K(int *hand, int len);
        bool Is1HeartA(int *hand, int len);
        bool IsSameBomb(int *hand, int len);
        bool IsBomb2W(int *hand, int len);
        bool Is2HeartA(int *hand, int len);
        bool IsAirPlane(int *hand, int len);
        ...
        bool IsBiggerThan(StaticAnalyserC *target);
        void printDes();
    private:
